...
<>
        {session?.user?.name === "null" ? (
            ...
            <ul className={styles.ul}>
                <span>
                    ...
                    <li><NavItem linkHref={`/profile/${session?.user?.name}`} path="/profile-icon.svg" imgAlt="Profile icon" text="My Profile"></NavItem></li>
                </span>
            ...
            <ul className={styles.ul}>
                <span>
                    ...
                    <li><NavItem linkHref="/new-bomb" path="/newBomb.svg" imgAlt="New Bomb icon" text="New Bomb"></NavItem></li>
                    <li className={styles.notificationsListItem}><NavItem linkHref="/notifications" path="/notifications.svg" imgAlt="Notifications icon" text="Notifications"></NavItem></li>
                    <li><NavItem linkHref={`/profile/${session?.user?.username}`} path="/profile-icon.svg" imgAlt="Profile icon" text="My Profile"></NavItem></li>
                </span>
                <span className={styles.lastChild}>
                    <li>
                        <NavItem onClickEvent={() => signOut({ callbackUrl: "/login" })} linkHref="/login" path="/logout.svg" imgAlt="Logout icon" text="Logout"></NavItem>
        ...
        //             <li><NavItem linkHref="/new-bomb" path="/newBomb.svg" imgAlt="New Bomb icon" text="New Bomb"></NavItem></li>
        //             <li className={styles.notificationsListItem}><NavItem linkHref="/notifications" path="/notifications.svg" imgAlt="Notifications icon" text="Notifications"></NavItem></li>
        //             <li><NavItem linkHref={`/profile/${status?.user?.name}` || `/profile/${status?.user?.username}`} path="/profile-icon.svg" imgAlt="Profile icon" text="My Profile"></NavItem></li>
        //         </span>
        //         <span className={styles.lastChild}>
        //             <li>
        //                 <NavItem onClickEvent={() => signOut({ callbackUrl: "/login" })} linkHref="/login" path="/logout.svg" imgAlt="Logout icon" text="Logout"></NavItem>
